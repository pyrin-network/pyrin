...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] pyrin_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] pyrin_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] pyrin_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] pyrin_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(pyrin_metrics_core::error::Error),

    #[error(transparent)]
    PyrinWalletKeys(#[from] pyrin_wallet_keys::error::Error),
}

use crate::imports::*;
use pyrin_wallet_core::tx::PaymentDestination;
...
impl Estimate {
    async fn main(self: Arc<Self>, ctx: &Arc<dyn Context>, argv: Vec<String>, _cmd: &str) -> Result<()> {
        ...
        let amount_sompi = try_parse_required_nonzero_pyrin_as_sompi_u64(argv.first())?;
        let priority_fee_sompi = try_parse_optional_pyrin_as_sompi_i64(argv.get(1))?.unwrap_or(0);

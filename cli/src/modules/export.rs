use crate::imports::*;
use pyrin_wallet_core::account::{multisig::MultiSig, Account, MULTISIG_ACCOUNT_KIND};
...
async fn export_multisig_account(ctx: Arc<PyrinCli>, account: Arc<MultiSig>) -> Result<()> {
...
async fn export_single_key_account(ctx: Arc<PyrinCli>, account: Arc<dyn Account>) -> Result<()> {

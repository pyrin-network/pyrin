...
use pyrin_addressmanager::{AddressManager, NetAddress};
use pyrin_core::{debug, info, warn};
use pyrin_p2p_lib::{common::ProtocolError, ConnectionError, Peer};
...
pub struct ConnectionManager {
    p2p_adaptor: Arc<pyrin_p2p_lib::Adaptor>,
...
impl ConnectionManager {
    ...
    async fn handle_outbound_connections(self: &Arc<Self>, peer_by_address: &HashMap<SocketAddr, Peer>) {
        let active_outbound: HashSet<pyrin_addressmanager::NetAddress> =

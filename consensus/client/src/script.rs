...
use pyrin_wasm_core::types::{BinaryT, HexString};

use crate::imports::*;
use crate::result::Result;
use pyrin_txscript::script_builder as native;

#[wasm_bindgen(typescript_custom_section)]
const TS_SCRIPT_OPCODES: &'static str = r#"
/**
 * Pyrin Transaction Script Opcodes
...
impl Default for ScriptBuilder {
    fn default() -> Self {
        Self { script_builder: Rc::new(RefCell::new(pyrin_txscript::script_builder::ScriptBuilder::new())) }
    }
}
...
impl ScriptBuilder {
    ...
    /// and any push of data greater than [`MAX_SCRIPT_ELEMENT_SIZE`](pyrin_txscript::MAX_SCRIPT_ELEMENT_SIZE) will not modify
    ...
    /// exceed the maximum allowed script engine size [`MAX_SCRIPTS_SIZE`](pyrin_txscript::MAX_SCRIPTS_SIZE).

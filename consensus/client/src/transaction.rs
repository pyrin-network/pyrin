...
use pyrin_consensus_core::network::NetworkTypeT;
use pyrin_consensus_core::subnets::{self, SubnetworkId};
use pyrin_consensus_core::tx::UtxoEntry;
use pyrin_txscript::extract_script_pub_key_address;
use pyrin_utils::hex::*;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<pyrin_addresses::AddressArrayT> {

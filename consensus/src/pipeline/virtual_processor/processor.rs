...
use pyrin_consensusmanager::SessionLock;
use pyrin_core::{debug, info, time::unix_now, trace, warn};
use pyrin_database::prelude::{StoreError, StoreResultEmptyTuple, StoreResultExtensions};
use pyrin_hashes::Hash;
use pyrin_muhash::MuHash;
use pyrin_notify::{events::EventType, notifier::Notify};

use crossbeam_channel::{Receiver as CrossbeamReceiver, Sender as CrossbeamSender};
use itertools::Itertools;
use pyrin_utils::binary_heap::BinaryHeapExtensions;
...
impl VirtualStateProcessor {
    ...
    pub(crate) fn build_block_template_from_virtual_state(
        ...
        let accepted_id_merkle_root = pyrin_merkle::calc_merkle_root(virtual_state.accepted_tx_ids.iter().copied());

...
macro_rules! trace {
    ($($t:tt)*) => {
        if pyrin_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            pyrin_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if pyrin_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            pyrin_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if pyrin_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            pyrin_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if pyrin_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            pyrin_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if pyrin_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            pyrin_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}

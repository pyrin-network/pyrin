...
use pyrin_consensus_core::hashing::sighash_type::SigHashType;
use pyrin_consensus_core::tx::VerifiableTransaction;
...
mod test {
    ...
    use pyrin_consensus_core::constants::{LEOR_PER_PYRIN, TX_VERSION};
    ...
    fn make_mock_transaction(lock_time: u64) -> (VerifiableTransactionMock, TransactionInput, UtxoEntry) {
        let dummy_prev_out = TransactionOutpoint::new(pyrin_hashes::Hash::from_u64_word(1), 1);

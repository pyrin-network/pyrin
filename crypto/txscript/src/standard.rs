...
use pyrin_consensus_core::tx::{ScriptPublicKey, ScriptVec};
    ...
    fn test_extract_address_and_encode_script() {
        ...
        let tests = vec![
            Test {
                ...
                expected_address: Ok("pyrin:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j".try_into().unwrap()),
            },
            Test {
                ...
                expected_address: Ok("pyrintest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrse6gdmpks".try_into().unwrap()),
            },
            Test {

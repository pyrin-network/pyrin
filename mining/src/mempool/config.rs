use pyrin_consensus_core::constants::TX_VERSION;
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`pyrin_consensus_core::config::params::Params`] instance.

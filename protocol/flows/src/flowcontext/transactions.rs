...
use pyrin_p2p_lib::{
    make_message,
    pb::{pyrind_message::Payload, InvTransactionsMessage, PyrindMessage},
    Hub,
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-PYRIND: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: PyrindMessage, should_throttle: bool) {
        if should_throttle {

...
use pyrin_p2p_lib::{
    ...
    pb::{pyrind_message::Payload, AddressesMessage, RequestAddressesMessage},
...
/// The maximum number of addresses that are sent in a single pyrin Addresses message.
const MAX_ADDRESSES_SEND: usize = 1000;

/// The maximum number of addresses that can be received in a single pyrin Addresses response.

...
use pyrin_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    pyrin_core::log::init_logger(None, "debug");
    ...
    let adaptor = pyrin_p2p_lib::Adaptor::bidirectional(ip_port, pyrin_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();

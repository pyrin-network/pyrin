...
/// The main object to create for managing a fully-fledged Pyrin P2P peer
pub struct Adaptor {
    //
...
impl Adaptor {
    ...
    /// Creates a P2P adaptor with only client-side support. Typical Pyrin nodes should use `Adaptor::bidirectional`

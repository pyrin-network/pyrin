use crate::{
    ...
    handshake::PyrindHandshake,
    pb::{self, VersionMessage},
    IncomingRoute, PyrindMessagePayloadType, Router,
};
use pyrin_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            PyrindMessagePayloadType::Addresses,
            PyrindMessagePayloadType::Block,
            PyrindMessagePayloadType::Transaction,
            PyrindMessagePayloadType::BlockLocator,
            PyrindMessagePayloadType::RequestAddresses,
            PyrindMessagePayloadType::RequestRelayBlocks,
            PyrindMessagePayloadType::RequestTransactions,
            PyrindMessagePayloadType::IbdBlock,
            PyrindMessagePayloadType::InvRelayBlock,
            PyrindMessagePayloadType::InvTransactions,
            PyrindMessagePayloadType::Ping,
            PyrindMessagePayloadType::Pong,
            // PyrindMessagePayloadType::Verack,
            // PyrindMessagePayloadType::Version,
            // PyrindMessagePayloadType::Ready,
            PyrindMessagePayloadType::TransactionNotFound,
            PyrindMessagePayloadType::Reject,
            PyrindMessagePayloadType::PruningPointUtxoSetChunk,
            PyrindMessagePayloadType::RequestIbdBlocks,
            ...
            PyrindMessagePayloadType::RequestNextHeaders,
            PyrindMessagePayloadType::DoneHeaders,
            PyrindMessagePayloadType::RequestPruningPointUtxoSet,
            PyrindMessagePayloadType::RequestHeaders,
            PyrindMessagePayloadType::RequestBlockLocator,
            PyrindMessagePayloadType::PruningPoints,
            PyrindMessagePayloadType::RequestPruningPointProof,
            ...
            PyrindMessagePayloadType::RequestIbdChainBlockLocator,
            PyrindMessagePayloadType::IbdChainBlockLocator,
            PyrindMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::PyrindMessage) -> bool {
        // echo
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate pyrin P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = PyrindHandshake::new(&router);
...
mod tests {
    ...
    async fn test_handshake() {
        pyrin_core::log::try_init_logger("debug");

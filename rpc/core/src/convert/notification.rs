...
use pyrin_consensus_notify::notification as consensus_notify;
use pyrin_index_core::notification as index_notify;
use std::sync::Arc;
...
impl From<&index_notify::UtxosChangedNotification> for UtxosChangedNotification {
    ...
    // Use pyrin_rpc_service::converter::index::IndexConverter instead.

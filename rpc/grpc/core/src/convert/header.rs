...
use pyrin_rpc_core::{FromRpcHex, RpcError, RpcHash, RpcResult, ToRpcHex};
use std::str::FromStr;
use pyrin_muhash::Blake2Hash as Blake2Hash;

// ----------------------------------------------------------------------------
// rpc_core to protowire
// ----------------------------------------------------------------------------

from!(item: &pyrin_rpc_core::RpcHeader, protowire::RpcBlockHeader, {
    Self {
...
try_from!(item: &protowire::RpcBlockHeader, pyrin_rpc_core::RpcHeader, {
    ...
    Self::new_finalized(
        ...
        item.nonce,
        item.daa_score,
        pyrin_rpc_core::RpcBlueWorkType::from_rpc_hex(&item.blue_work)?,
        item.blue_score,
...
mod tests {
    use crate::protowire;
    use pyrin_rpc_core::{RpcHash, RpcHeader};
    use pyrin_muhash::Blake2Hash as Blake2Hash;

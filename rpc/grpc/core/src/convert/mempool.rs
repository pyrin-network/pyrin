...
from!(item: &pyrin_rpc_core::RpcMempoolEntry, protowire::RpcMempoolEntry, {
    Self { fee: item.fee, transaction: Some((&item.transaction).into()), is_orphan: item.is_orphan }
});

from!(item: &pyrin_rpc_core::RpcMempoolEntryByAddress, protowire::RpcMempoolEntryByAddress, {
    Self {
...
try_from!(item: &protowire::RpcMempoolEntry, pyrin_rpc_core::RpcMempoolEntry, {
    Self::new(
        item.fee,
        item.transaction
            .as_ref()
...
try_from!(item: &protowire::RpcMempoolEntryByAddress, pyrin_rpc_core::RpcMempoolEntryByAddress, {
    Self::new(

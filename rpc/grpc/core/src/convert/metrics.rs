...
use pyrin_rpc_core::RpcError;

// ----------------------------------------------------------------------------
// rpc_core to protowire
// ----------------------------------------------------------------------------

from!(item: &pyrin_rpc_core::ProcessMetrics, protowire::ProcessMetrics, {
    Self {
...
from!(item: &pyrin_rpc_core::ConnectionMetrics, protowire::ConnectionMetrics, {
    Self {
...
from!(item: &pyrin_rpc_core::BandwidthMetrics, protowire::BandwidthMetrics, {
    Self {
...
from!(item: &pyrin_rpc_core::ConsensusMetrics, protowire::ConsensusMetrics, {
    Self {
...
try_from!(item: &protowire::ProcessMetrics, pyrin_rpc_core::ProcessMetrics, {
    Self {
        resident_set_size: item.resident_set_size,
        virtual_memory_size: item.virtual_memory_size,
        core_num: item.core_num,
...
try_from!(item: &protowire::ConnectionMetrics, pyrin_rpc_core::ConnectionMetrics, {
    Self {
        borsh_live_connections: item.borsh_live_connections,
        borsh_connection_attempts: item.borsh_connection_attempts,
        borsh_handshake_failures: item.borsh_handshake_failures,
...
try_from!(item: &protowire::BandwidthMetrics, pyrin_rpc_core::BandwidthMetrics, {
    Self {
        borsh_bytes_tx: item.borsh_bytes_tx,
        borsh_bytes_rx: item.borsh_bytes_rx,
        json_bytes_tx: item.json_bytes_tx,
...
try_from!(item: &protowire::ConsensusMetrics, pyrin_rpc_core::ConsensusMetrics, {
    Self {

...
use pyrin_rpc_core::{api::ops::RpcApiOps, prelude::*};
use pyrin_rpc_macros::build_wrpc_server_interface;
use std::sync::Arc;
...
/// a single initialization location for both the Pyrind Server and
/// the GRPC Proxy.
pub struct Router {

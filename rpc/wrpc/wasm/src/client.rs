...
pub struct Inner {
    ...
    notification_channel: Channel<pyrin_rpc_core::Notification>,
}
...
///
///
/// Pyrin RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Pyrin Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Pyrin Node or to a
...
/// ```
///
/// **Connecting to a Pyrin Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Pyrin node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            PyrinRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Pyrin RPC server. This function starts a background
    ...
    /// Disconnect from the Pyrin RPC server.
    ...
    /// however, you have to re-subscribe for Pyrin node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<PyrinRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<PyrinRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                pyrin_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = PyrinRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Pyrin BlockDAG.
    ...
    /// Pyrin BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Pyrin BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Pyrin BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Pyrin BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Pyrin BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Pyrin BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Pyrin BlockDAG.
    ...
    /// template is generated for mining in the Pyrin BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Pyrin BlockDAG.
        ...
        /// structure of the Pyrin BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Pyrin network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Pyrin node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Pyrin node.
        /// Returned information: Version of the Pyrin node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Pyrin
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Pyrin node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Pyrin node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Pyrin server.
        /// Returned information: Version of the Pyrin server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Pyrin node.
        /// Returned information: Syncing status.
        GetSyncStatus,
    ],
    [
        // functions with `request` argument
        /// Adds a peer to the Pyrin node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Pyrin node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Pyrin BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Pyrin BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Pyrin BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Pyrin BlockDAG.
        ...
        GetCurrentNetwork,
        /// Retrieves block headers from the Pyrin BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Pyrin node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Pyrin BlockDAG.
        ...
        /// Resolves a finality conflict in the Pyrin BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Pyrin network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Pyrin network.
        /// Returned information: None.
        SubmitTransaction,
        /// Unbans a previously banned peer, allowing it to connect
        /// to the Pyrin node again.
        /// Returned information: None.
        Unban,
    ]
);

...
use pyrin_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use pyrin_rpc_core::notify::mode::NotificationMode;
use pyrin_rpc_service::service::RpcCoreService;
use pyrin_utils::triggers::Listener;
use pyrind_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use pyrin_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_pyrin_tempdir();

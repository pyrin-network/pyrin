...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "pyrin_utils::serde_bytes_fixed")]
///     v: [u8; 20],
/// }
...
///     }
/// }
/// impl pyrin_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// pyrin_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// pyrin_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "pyrin_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///

//!
//! Legacy (KDX, pyrinnet.io Web Wallet) account implementation
//!

use crate::account::{AsLegacyAccount, Inner};
use crate::derivation::{AddressDerivationManager, AddressDerivationManagerTrait};
use crate::imports::*;
use pyrin_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "pyrin-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "Pyrin Legacy Account (KDX, pyrinnet.io Web Wallet)".to_string()
    }

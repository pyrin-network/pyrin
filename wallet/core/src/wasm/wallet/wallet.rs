...
use pyrin_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty Pyrin is developed in Rust, and the Wallet class is a Rust implementation

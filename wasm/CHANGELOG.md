Latest online documentation available at: https://pyrin.aspectron.org/docs/
### Release 2024-04-27
...
- Merge with Rusty Pyrin master (0.13.6)
...
- Rename `pyrin-beacon` app to `pyrin-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `pyrin-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://pyrin.aspectron.org/docs/

let pyrin = require('../../../../nodejs/pyrin');
let {
    PrivateKey,
    PublicKey,
    PublicKeyGenerator,
...
// Getting Pyrin Address from Private Key
...
function demoGenerateAddressFromPublicKeyHexString() {
    ...
    console.info(publicKey.toAddress(NetworkType.Mainnet).toString() == 'pyrin:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(xOnlyPublicKey.toAddress(NetworkType.Mainnet).toString() == 'pyrin:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(fullDERPublicKey.toAddress(NetworkType.Mainnet).toString() == 'pyrin:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq');
}
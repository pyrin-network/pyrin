...
const pyrin = require('../pyrin/pyrin_wasm');
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"pyrin:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "pyrintest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("pyrintest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new pyrin.TransactionOutput(300n, new pyrin.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new pyrin.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];

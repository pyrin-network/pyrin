...
(async () => {
    ...
    console.info(`Full pyrin address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Pyrin
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : pyrinToSompi(0.2)}],
            priorityFee: pyrinToSompi(0.0001),
